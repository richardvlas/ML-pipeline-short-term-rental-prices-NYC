...
def train_random_forest(args):
    ...
    # Then fit the pipeline sk_pipe by calling the .fit method on X_train and y_train
    logger.info("Fitting")
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        # Use wandb.Artifact to create an artifact. Use args.output_artifact 
        # as artifact name, "model_export" as type, provide a description and 
        ...
        # Use the .add_dir method of the artifact instance you just created to 
        # add the "random_forest_dir" directory to the artifact
        artifact.add_dir(export_path)

        # Finally use run.log_artifact to log the artifact to the run
    ...
    # Log the r_squared under the "r2" key and mae under the key "mae"
